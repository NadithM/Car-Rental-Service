...
@Service
@Slf4j
public class RegisterVehicleAvailabilityServiceImpl extends AbstractVehicleServiceHandler implements AbstractExecutorService {

    @ServiceActivator(inputChannel = "defaultCommonVehicleRegisterAvailabilityChannel")
    public Message<Void> executeProcess(Message<? extends BasicRequestCriteria> vehicleCriteriaMessage) {
        ...
        try {
            ...
            Vehicle vehicle = basicVehicleHandler.registerVehicleAvailability(basicRequestCriteria);
