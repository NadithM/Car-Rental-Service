...
@Service
@Slf4j
public class RegisterVehicleServiceImpl extends AbstractVehicleServiceHandler implements AbstractExecutorService {

    @ServiceActivator(inputChannel = "defaultCommonVehicleRegisterChannel")
    public Message<Void> executeProcess(Message<? extends BasicRequestCriteria> vehicleCriteriaMessage) {
        ...
        try {
            ...
            Vehicle vehicle = basicVehicleHandler.registerVehicle(basicRequestCriteria);
